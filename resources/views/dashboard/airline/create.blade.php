...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form role="form" method="POST" action="{{ url('airline') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6 @error('name') input-was-validated @enderror">
                            ...
                            <input type="text" name="name" class="form-control" id="inputairline" placeholder="Airline Name" value="{{ old('name') }}">
                             @error('name')
                        ...
                        <div class="form-group col-md-6 @error('address') input-was-validated @enderror">
                            ...
                            <input type="text" name="address" class="form-control" id="inputAirlineAddress" placeholder="airline Code" value="{{ old('address') }}">
                             @error('address')
                        ...
                        <div class="form-group col-md-6 @error('website') input-was-validated @enderror">
                            ...
                            <input type="text" name="website" class="form-control" id="inputAirlineWebsite" placeholder="Website" value="{{ old('website') }}">
                             @error('website')
                        ...
                        <div class="form-group col-md-6 @error('phone') input-was-validated @enderror">
                            ...
                            <input type="text" name="phone" class="form-control" id="inputAirlinePhone" placeholder="Phone" value="{{ old('phone') }}">
                             @error('phone')
